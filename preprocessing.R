# TODO: make different scripts out of the different tasks!
# Station data, Station_Metadata, River-Temperature data, Index-Calculation + Index-Interpolation
# Loading + Processing all files for visualization / e.g. Shiny-App
...
###################################################################################################
# TODO: if outfile already exists then only open outfile and do not repeat the whole process!
...
# TODO: could be normalized such that maximum and minimum values would be at 0 (as it is) and at 100 (currently 98.5)
...
#Write csv
write.csv(joined, "data/badeindex.csv", row.names = F, na = "-", fileEncoding = "ISO-8859-1")
...
# write JSON
write(data, file="data/flussdaten.json")
